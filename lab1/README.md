...
**Выполнила:**
Студентка группы **6212-100503D**
ФИ **Козленко Екатерина**
...
<img width="2400" height="1800" alt="kk" src="https://github.com/user-attachments/assets/94a99928-856d-4c8b-b11b-6234ce60e4ed" />
<img width="2400" height="1800" alt="kk1" src="https://github.com/user-attachments/assets/b93752d9-0efa-47b8-a198-1bb3a7eab271" />
...
В ходе работ я написала программу на языке C/C++ для перемножения двух квадратных матриц и установила зависимость времени умножения от количества данных.
